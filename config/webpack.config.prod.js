...
module.exports = {
    ...
    loaders: [
      ...
      // images
      {
        ...
        loaders: [
          ...
          'image-webpack?{optimizationLevel: 7, interlaced: false, pngquant:{quality: "65-90", speed: 4}, mozjpeg: {quality: 8}}'
        ]
      },
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({GA_TRACKING_CODE: JSON.stringify('UA-47062481-1')}),
